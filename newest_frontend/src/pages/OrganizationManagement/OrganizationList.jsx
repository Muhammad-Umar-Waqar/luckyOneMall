...
//   // Render the main list UI so we can reuse it inside the Drawer
//   const renderList = () => (
//     <div className="ListPage organization-list-container bg-white rounded-xl shadow-sm w-full h-full border border-[#E5E7EB]">
//       <h1 className="organization-list-title font-semibold text-gray-800 mb-4">Organization Management</h1>
//       <div className="mb-4">
...
//       {/* On desktop show the list inline. On mobile we still render nothing here
//           (drawer will contain the list). If you want to show a compact view on mobile, place it here. */}
//       {isDesktop && (
//         <div className="p-4">
//           {renderList()}
//         </div>
...
//       {/* Drawer for mobile (<768px) */}
//       <Drawer
//         anchor="right"
//         open={mobileOpen}
//         onClose={() => setMobileOpen(false)}
//         PaperProps={{
//           sx: { width: { xs: "100%", sm: 380 }, maxWidth: "100%" } // adjust width as needed
//         }}
//       >
//         <div className="flex items-center justify-between p-4 border-b">
//           <h3 className="font-semibold text-lg">Organization List</h3>
//           <IconButton onClick={() => setMobileOpen(false)} aria-label="close drawer">
//             <X />
//           </IconButton>
//         </div>
