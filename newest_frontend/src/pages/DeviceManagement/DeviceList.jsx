...
const DeviceList = ({ onDeviceSelect, selectedDevice }) => {
  ...
  return (
    <>
      ...
      {/* Edit Dialog */}
      <Dialog open={editOpen} onClose={handleEditCancel} maxWidth="xs" fullWidth>
        {/* ...keep your existing edit dialog content exactly as-is */}
        <DialogTitle>Edit Device</DialogTitle>
        <DialogContent dividers>
    <Stack spacing={2} alignItems="center" justifyContent="center">
  ...
  {/* Shared constants so both rows match */}
  {/* change these if you want different sizes */}
  {/* operatorWidth: width of the Select on xs; valueMax: max width of TextField on xs */}
  {/**/}
  <>
    {/* Ambient row */}
